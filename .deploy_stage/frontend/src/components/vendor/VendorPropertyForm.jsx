        ...
        >
          ...
          <PropertyImageUpload
            ...
            onImagesChange={({
              ...
              // Keep photoUrls in sync so the PATCH payload always reflects
              // the actual uploaded images (prevents overwriting with empty array)
              if (ui && ui.length > 0) {
                setPhotoUrls(ui.map((img) => img.image_url).filter(Boolean));
              }
            }}
