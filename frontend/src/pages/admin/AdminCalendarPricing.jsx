...
export default function AdminCalendarPricing() {
  ...
  // Derive unique vendors, cities and areas from loaded properties
  const vendors = useMemo(() => {
    const map = new Map();
    properties.forEach((p) => {
      if (p.vendor_id && p.vendor_name) map.set(p.vendor_id, p.vendor_name);
    });
    ...
    <div className="mx-auto">
      ...
      <div className="flex gap-3 mb-5">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {/* Area filter — only populated for selected city */}
          <Select
            value={areaFilter}
